...
Programmeur :
        ...
        Sitbon Samuel
Main.py : fichier réalisant l'ensemble du programme du chatbot
"""
...
if __name__=="__main__":
    ...
    while saisie_choix != 1 and saisie_choix != 2:
        print("\n--- Menu ---\n\n"
              "- Pour utiliser le Menu sur la console, tapez 1\n"
              "- Pour utiliser le Menu sur une fenêtre, tapez 2\n")
        try:
            saisie_choix = int(input("Entrez votre choix : "))
        except ValueError:
            print("Veuillez entrer un nombre valide.")

        if saisie_choix != 1 and saisie_choix != 2:
    ...
    if saisie_choix==2:
        #menu fenetre certaines lignes de codes sont inspirés des exemples sur le site Python.doctor ainsi Chatgpt
        ...
        btn_moins_importants = tk.Button(window, text="Afficher les mots les moins importants", command=lambda: afficher_mots_moins_importants(mot_pas_important))
        btn_plus_importants = tk.Button(window, text="Afficher le mot le plus important", command=lambda: afficher_mots_plus_importants(mot_import_dossier))
        ...
        photo = PhotoImage(file="chatbofnoir.png")
